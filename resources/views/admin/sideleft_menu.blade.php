<div class="sl-sideleft">
    <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('sub-category.index') }}" class="nav-link">Sub Category</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('blog-posts.create') }}" class="nav-link">Add Post</a></li>
            <li class="nav-item"><a href="{{ route('blog-posts.index') }}" class="nav-link">All Posts</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('index.newsletters') }}" class="nav-link">Newsletters</a></li>
