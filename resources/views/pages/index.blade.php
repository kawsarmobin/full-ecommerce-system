...
@section('content')
    ...
    @php
        ...
        $hot_deal = DB::table('products')->join('brands', 'products.brand_id', 'brands.id')->select('products.*', 'brands.name')->where('products.status', 1)->where('products.hot_deal', 1)->orderBy('id', 'desc')->limit(5)->get();
                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                                ...
                                <div class="owl-item deals_item">
                                    <div class="deals_image">
                                        <img src="{{ \App\Model\Admin\Product::ATTACH_UPLOAD_PATH.'/'.$row->image_one }}" width="310px" height="310px">
                                    </div>
                                    <div class="deals_content">
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_category"><a href="#">{{ $row->name }}</a></div>
                                            <div class="deals_item_price_a ml-auto">
                                                {{ $row->discount_price == NULL ? '' : '$' . $row->selling_price }}
                                            </div>
                                        </div>
                                        <div class="deals_info_line d-flex flex-row justify-content-start">
                                            <div class="deals_item_name">{{ $row->product_name }}</div>
                                            <div class="deals_item_price ml-auto">
                                                {{ $row->discount_price ? '$' . $row->discount_price : '$' . $row->selling_price }}
                                            </div>
                                        </div>
                                        <div class="available">
    ...
    <!-- Banner -->
    @php
        $products = DB::table('products')->join('categories', 'products.category_id', 'categories.id')->join('brands', 'products.brand_id', 'brands.id')
                                ->select('products.*', 'categories.name as cat_name', 'brands.name as brand_name')
                                ->where('status', 1)->where('mid_slider', 1)->orderBy('id', 'desc')->limit(4)->get();
    @endphp
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        <div class="banner_2_category">{{ $row->cat_name }}</div>
                                ...
                                <div class="col-lg-8 col-md-6 fill_height">
                                    <div class="banner_2_image_container">
                                        <div class="banner_2_image"><img
                                                src="{{ \App\Model\Admin\Product::ATTACH_UPLOAD_PATH.'/'.$row->image_one }}" width="858px" height="476px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="arrivals_slider slider">
                                        ...
                                        <div class="arrivals_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ \App\Model\Admin\Product::ATTACH_UPLOAD_PATH.'/'.$row->image_one }}" width="115px" height="81px">
                                                </div>
                                                <div class="product_content">
                                                ...
                                                <ul class="product_marks">
                                                    @if($row->discount_price)
                                                        @php
                                                            ...
                                                            $discount = $amount / $row->selling_price * 100;
                                                        @endphp
                                                        <li class="product_mark product_new bg-danger">{{ intval($discount) }}%</li>
                                                    @else
    ...
    <!-- Electronics Arrivals -->

    @php
        $category = DB::table('categories')->skip(6)->first();
        $category_id = $category->id;
        $products = DB::table('products')->where(['category_id' => $category_id, 'status' => 1])->limit(16)->get();
    @endphp
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="tabbed_container">
                        <div class="tabs clearfix tabs-right">
                            <div class="new_arrivals_title">{{ $category->name }}</div>
                            <ul class="clearfix">
                                <li></li>
                            </ul>
                            <div class="tabs_line"><span></span></div>
    ...
    @php
        $buy_get = DB::table('products')->where(['buyone_getone' => 1, 'status' => 1])->limit(12)->get();
    @endphp
                ...
                <div class="col-lg-9">
                    <div class="trends_slider_container">
                        ...
                        <div class="owl-carousel owl-theme trends_slider">
                            ...
                            @foreach($buy_get as $row)
                                <!-- Trends Slider Item -->
                                    <div class="owl-item">
                                        <div class="trends_item is_new">
                                            <div
                                                class="trends_image d-flex flex-column align-items-center justify-content-center">
                                                <img src="{{ \App\Model\Admin\Product::ATTACH_UPLOAD_PATH.'/'.$row->image_one }}" alt=""></div>
                                            <div class="trends_content">
                                                ...
                                                <div class="trends_info clearfix">
                                                    ...
                                                    <div class="trends_price">
                                                        @if($row->discount_price)
                                                            ${{ $row->discount_price }} <span class="trends_category"><a class="text-muted">${{ $row->selling_price }}</a></span>
                                                        @else
                                                            ${{ $row->selling_price }}
                                                        @endif
                                                    </div>
                                            ...
                                            <br>
                                            <a href="#" class="btn btn-sm btn-danger btn-block">Add to Cart</a>
                                            <ul class="trends_marks">
                                                @if($row->discount_price)
                                                    @php
                                                        ...
                                                        $discount = $amount / $row->selling_price * 100;
                                                    @endphp
                                                    <li class="trends_mark trends_new bg-danger">{{ intval($discount) }}%</li>
                                                @else
                                            ...
                                            <button class="add-wishlist" data-id="{{ $row->id }}">
                                                @if($wishlist)
                                                    <div class="trends_fav"><i class="fas fa-heart text-danger"></i></div>
                                                @else
                        ...
                        <div class="owl-carousel owl-theme viewed_slider">
                            ...
                            <div class="owl-item">
                                <div
                                    ...
                                    <div class="viewed_image"><img
                                            src="{{ asset('public/frontend/images/view_1.jpg') }}" alt=""></div>
                            ...
                            <div class="owl-item">
                                <div
                                    ...
                                    <div class="viewed_image"><img
                                            src="{{ asset('public/frontend/images/view_2.jpg') }}" alt=""></div>
                                    <div class="viewed_content text-center">
                            ...
                            <div class="owl-item">
                                <div
                                    class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img
                                            src="{{ asset('public/frontend/images/view_3.jpg') }}" alt=""></div>
                                    <div class="viewed_content text-center">
                            ...
                            <div class="owl-item">
                                <div
                                    ...
                                    <div class="viewed_image"><img
                                            src="{{ asset('public/frontend/images/view_4.jpg') }}" alt=""></div>
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">$379</div>
                            ...
                            <div class="owl-item">
                                <div
                                    class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img
                                            src="{{ asset('public/frontend/images/view_5.jpg') }}" alt=""></div>
                                    <div class="viewed_content text-center">
                                        <div class="viewed_price">$225<span>$300</span></div>
                            ...
                            <div class="owl-item">
                                <div
                                    class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img
                                            src="{{ asset('public/frontend/images/view_6.jpg') }}" alt=""></div>
                                    <div class="viewed_content text-center">
